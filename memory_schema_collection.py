...
model = llm.with_structured_output(MemoryCollection)

memory_collection = model.invoke([HumanMessage('hi this is sunil and i liked cooking, i want to go on a ride')])
...
print(f'memory collection{memory_collection.memories}')
