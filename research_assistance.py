...
graph.update_state(thread, {"human_analyst_feedback":
                            "create analyst from medical firms"}, as_node="human_feedback")
...
# now we have the analysts lets create an interview bw analyst and expert
# each analyst will ask questions to expert
...
## here we define what analyst is supposed to ask an expert
## basically how analyst will create a question to ask to expert
...
## once question generated we create search query to get the data
...
print('first analyst', analysts[0])
...
# Save it to a file in your project folder
with open("interview.png", "wb") as f:
    f.write(png_data)
